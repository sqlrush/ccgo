...
- `internal/session`: Claude transcript JSONL 路径、读写、metadata/index/resume、sidechain 路径/runtime/state/resume/resume-context 和消息落盘。
...
- `internal/tui`: terminal frame renderer、prompt input、mouse input、keybinding/config、vim 基础、REPL screen、permission/task dialogs/runtime、idempotent alternate screen lifecycle/reset、ANSI snapshot/corpus、viewport/selection 和基础组件。
