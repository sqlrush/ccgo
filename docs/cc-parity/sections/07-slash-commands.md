...
| CMD-TASKS-01 | `/tasks` 打开任务管理界面 | MANUAL | 前置:REPL 中; 操作:`/tasks`; 预期:打开任务列表 overlay | `src/commands/tasks/index.ts:5` / `commands.ts:340` | ⚠️ 已建未接（F4 commit 12cabdf）（registered + router handler；返回信息性消息；后台 task infra 尚未实现） |
...
小计: 73 项 — ✅ 38 / ⚠️ 11 / ❌ 0 / N/A 24（F4 commit 12cabdf 新增 11 ✅ / 6 ⚠️；PRCMTS 由 ❌ 翻为 N/A；CMD-RESUME-02/CMD-MEMORY-01/CMD-MODEL-01 经 W-REPL 接线 commit 4c3d7f8 由 ⚠️ 翻为 ✅；⚠️ 命令均已注册+接线，受限于 TUI infra 缺失；渲染需人工核验）
