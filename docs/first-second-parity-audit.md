...
- `internal/tui`: terminal CSI parsing now emits edit actions for REP repeat-preceding-character sequences such as `CSI b` and `CSI 4b`, preserving the repeat count for later renderer expansion.
