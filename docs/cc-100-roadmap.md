...
| 文件工具 M5 初版 | 已完成文本版 `Read`、image Read 初版、Read 大文本预算截断/落盘、`Write`、`Edit`，含读前写、mtime stale guard、`replace_all`、Read 去重 |
...
- 文本版 `Read`、PNG/JPEG/GIF/WebP image Read、Read 大文本 tool-result budget 截断/落盘、`Write`、`Edit` 初版已完成。
...
- `Read` 的 PDF/notebook、完整 token-budget parity、full media parity、binary edge cases。
