...
func BuiltinCommands() []contracts.Command {
	return cloneCommands([]contracts.Command{
		...
		{Type: contracts.CommandLocal, Name: "native", Description: "Run explicit native integration commands", ArgumentHint: "clipboard [read|write <text>]", Source: contracts.CommandSourceBuiltin, SupportsNonInteractive: true},
