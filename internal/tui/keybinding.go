...
func DefaultKeymap() Keymap {
	return Keymap{Bindings: map[KeyType]Action{
		...
		KeyShiftEnter: ActionInsertNewline,
		KeyEsc:        ActionCancel,
		...
		KeyAltLeft:    ActionMoveWordLeft,
		KeyCtrlLeft:   ActionMoveWordLeft,
		KeyRight:      ActionMoveRight,
		KeyCtrlF:      ActionMoveRight,
		KeyAltF:       ActionMoveWordRight,
		KeyAltRight:   ActionMoveWordRight,
		KeyCtrlRight:  ActionMoveWordRight,
		...
		KeyCtrlP:      ActionHistoryPrevious,
		KeyDown:       ActionHistoryNext,
		KeyCtrlN:      ActionHistoryNext,
