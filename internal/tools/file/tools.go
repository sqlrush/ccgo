...
func BuiltinTools() []tool.Tool {
	return []tool.Tool{NewReadTool(), NewEditTool(), NewWriteTool(), bashtools.NewBashTool(), NewGlobTool(), NewGrepTool(), todotools.NewTodoWriteTool(), webtools.NewWebFetchTool(), webtools.NewWebSearchTool()}
}
